...
import { applyT2Rules } from "../common/excel_utils.js";
  ...
  async getT2Data(customDays = null) {
    try {
      ...
      WHERE
          ...
          order.Custom_OrderStatus__c NOT IN ('Superseded', 'Activated','Cancelled', 'Discarded') AND
          order.Order_Nature__c includes ('New installation','External Relocation', 'Internal Relocation')`;
